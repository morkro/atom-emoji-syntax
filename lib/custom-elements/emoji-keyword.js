...
import { HTML, createNode, getHexadecimalUnicode } from '../helpers'
import { EMOJI_KEYWORD } from '../constants/custom-elements'
...
class KeywordElement extends HTMLElement {
	...
	createEmojiConfig (value) {
		...
		this.emoji.$el.textContent = value

		$btn.appendChild(this.emoji.$el)
		$btn.appendChild(this.unicode.$el)
