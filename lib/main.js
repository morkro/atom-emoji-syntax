...
const EmojiSyntax = {
	...
	activate (state) {
		...
		this.settings = this.createSettingsView(state.settings);
		...
		this.subscriptions.add(
			...
			atom.config.onDidChange('emoji-syntax.emojiStyles', this.updateSettings.bind(this))
		);
	...
	/**
	 * Updates the settings constructor.
	 * @param  {Object} data
	 * @return {Void}
	 */
	updateSettings (data) {
		this.settings.update(data.newValue);
	},
