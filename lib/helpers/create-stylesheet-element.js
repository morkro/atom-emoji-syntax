 ...
 * @param {String} options.selector - The className ofthe element
 * @param {String} options.context - Content for custom attribute "content"
 * @param {(Number|String)} options.priority - Content for custom attribute
 *
